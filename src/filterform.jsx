const FilterForm = ({
    ...
    <div className="filtres">
        ...
        <label>
            ...
            <input type="number" value={minQueryImpressions} onChange={(e) => setMinQueryImpressions(e.target.value)} />
        </label>
        <label>
            Min Page Impressions:
            <input type="number" value={minPageImpressions} onChange={(e) => setMinPageImpressions(e.target.value)} />
        </label>
    </div>
</div>
);
